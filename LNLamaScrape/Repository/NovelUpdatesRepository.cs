...
{
    internal class NovelUpdatesRepository : RepositoryBase
    {
        public static readonly RepositoryType RepositoryType = RepositoryType.LightNovel;
        private static readonly Uri RepoIndexUri = new Uri("https://www.novelupdates.com/novelslisting/");

        public NovelUpdatesRepository(WebClient webClient) : base(webClient, "Novel Updates", "https://www.novelupdates.com/", "NovelUpdates.png"
